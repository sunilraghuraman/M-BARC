...
F = fopen('Pic.bmp', 'wb');             % Creating a binary file.
...
fwrite(F, 1, 'uint16');                 % Number of color planes, always 1 (2 bytes).
fwrite(F, 8, 'uint16');                 % Number of bits per pixel (2 bytes).
fwrite(F, 1, 'uint32');                 % Type of compression (0 none, 1 RLE-8, 2 RLE-4) (4 bytes).
